...
define("_NOTE_GEOLOC",		"Note : cette fonctionnalité utilise la géolocalisation. Il n'est pas toujours
							...
							votre connexion internet.""注意：此功能需要用到定位。只有在您的定位器工作正常和网络连接的情况下才可以确定您的位置");
define("_OPTIONS",			"选项 :");
define("_RANGE",			"范围 (km) : ");
define("_MAX_POI",			"最大值 :");
...
define("_ABOUT_TEXT","		
							...
							<p>
							如果您已经用过了WanderWiki<a href=\"http://wiki-geolocalisation.wix.com/wanderwiki\">WanderWiki</a>，您就不会对我们的项目感到困惑。Wikijourney是WanderWiki的继承，提供全新的地图和更多更强大的功能。
							</p>

							<h2>问题和建议 </h2>
							<p>
							我们希望倾听您的所有意见或建议。通过电子邮件 <a href=\"mailto:wikijourneydev@gmail.com\">en nous contactant par mail</a> 或者直接通过Git编程来提出您的建议吧！
							</p>");
