...
<?php
	...
	<nav class="right_menu">
		<ul>
			...
			<li id="lien_paths.php"><a href="paths.php"><?php echo _YOUR_PATHS;?></a></li>
						<!--devrait afficher un moyen de se connecter si l'utilisateur ne l'est pas, et
						un onglet des parcours existants s'il l'est -->
